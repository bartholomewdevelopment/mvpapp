      ...
      <div className="container relative mx-auto px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-20">
            <Card className="group hover:shadow-lift-high transition-all duration-200 ease-signature border border-white/10 shadow-lg bg-white/[0.024] backdrop-blur-sm">
              <CardContent className="p-8">
                <div className="flex items-center mb-6">
                  <div className="w-14 h-14 bg-gradient-to-br from-[#fd6a62] to-[#fc5951] rounded-card flex items-center justify-center mr-4 group-hover:scale-110 transition-transform duration-200 ease-signature shadow-lift">
          ...
          <div className="bg-white/[0.03] border border-white/10 rounded-panel p-8 lg:p-12 text-center relative overflow-hidden mb-16">
            <div className="absolute inset-0 bg-gradient-to-r from-[#fd6a62]/10 to-[#fc5951]/10"></div>
            <div className="relative z-10">
              <div className="flex items-center justify-center mb-6">
                <div className="w-16 h-16 bg-gradient-to-br from-[#fd6a62] to-[#fc5951] rounded-card flex items-center justify-center shadow-lift">
              ...
              <div className="px-4">
                <Button
                  size="lg"
                  className="group relative bg-gradient-to-r from-[#fd6a62] to-[#fc5951] hover:from-[#fc5951] hover:to-[#fd6a62] text-white px-8 sm:px-12 py-4 text-base sm:text-lg font-semibold shadow-lift transform hover:scale-105 transition-all duration-150 ease-signature rounded-xl w-full sm:w-auto overflow-hidden"
          ...
          <div className="relative">
            ...
            <div className="grid lg:grid-cols-[340px_1fr] gap-10 lg:gap-16 items-center">
              ...
              <div className="relative mx-auto lg:mx-0">
                ...
                {/* Photo container */}
                <div className="relative w-64 h-80 sm:w-72 sm:h-[22rem] rounded-card overflow-hidden shadow-lift-high shadow-black/40 border border-white/10">
                  <img
                ...
                <div className="absolute -top-3 -right-3 sm:-right-5 bg-gradient-to-br from-[#fd6a62] to-[#fc5951] rounded-xl px-4 py-2.5 shadow-lift z-10">
              ...
              <div className="text-center lg:text-left">
                ...
                <div className="flex flex-wrap justify-center lg:justify-start gap-3 mb-8">
                  {[
                    ...
                    <span
                      key={tag}
                      className="px-4 py-1.5 rounded-full text-sm font-medium bg-white/[0.06] border border-white/10 text-ink-muted"
                    >
                      {tag}
                    </span>
                  ))}
